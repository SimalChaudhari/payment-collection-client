...
export const adminRoutes = [
  {
    ...
    pages: [
      ...
      { icon: <UserCircleIcon {...icon} />, name: "Salesman's", path: "/salesmans", element: <ViewSalesman /> },
...
export const customerRoutes = [
  {
    ...
    pages: [
      ...
      { icon: <CreditCardIcon {...icon} />, name: "Verify Payments", path: "/verify", element: <PaymentVerify /> },
      { icon: <UserCircleIcon {...icon} />, name: "Profile", path: "/profile", element: <AdminProfile /> },
      // { path: "*", element: <NotFound /> }, // 404 Page
    ],
  },
